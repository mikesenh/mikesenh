<div class="text-center my-12 mb-24 mx-5">
  <p class="text-lg mb-3">Design +Case Study</p>
  <h1 class="lg:text-6xl text-5xl font-semibold">Grace Company</h1>
  <p class="text-xl mt-3">The Maker of Fine Quilting Products</p>
</div>
...
<div>
  ...
  >
    ...
    <span class="self-start mt-5 mx-2">
      ...
      <p class="text-lg">
        As a web designer for The Grace Company, my objective was to enhance and
        modernize the company's website, aligning it with contemporary design
        trends and creating a cohesive design system. Collaborating with a
        skilled team of graphic designers and marketers, we aimed to revitalize
        the brand image and improve the user experience, ultimately driving
        increased sales and positioning the company as a leader in the quilting
...
<div class="2xl:mx-40 xl:mx-20 lg:mx-10 mx-5 my-20">
  ...
  <img
    ...
    loading="lazy"
    src="/project/grace/oldnewlogo.webp"
    alt=""
  />
</div>
...
<div class="2xl:mx-40 xl:mx-20 lg:mx-10 mx-5 my-20">
  ...
  <img
    ...
    loading="lazy"
    src="/project/grace/gf-color.webp"
    alt=""
  />
  ...
  <img
    class="rounded-xl shadow-lg w-full"
    loading="lazy"
    src="/project/grace/gf-before-after.webp"
    alt=""
  />
</div>
...
The data collected from this focus group study guided us in implementing changes on the website, such as optimizing the navigation flow, streamlining the checkout process, and enhancing the product presentation.
  ...
  <img
    class="rounded-xl shadow-lg w-full"
    loading="lazy"
    src="/project/grace/gf-casestudy.webp"
    alt=""
  />
  <p class="mt-4">This image showcases the games and detailed notes taken during a UX research project.</p>
</span>
</div>
</div>
  ...
  <div class="grid lg:grid-cols-2 grid-cols-1">
    <span>
      <img
        class="rounded-xl shadow-lg w-full"
        loading="lazy"
        src="/project/grace/gf-vote-v2.webp"
        alt=""
      />
      <p class="mt-4">This image displays different versions of a product page used in a focus group to gather feedback on customer preferences.</p>
    </span>
    <span class="flex items-center">
    <span class="lg:m-10 m-0">
      <div class="border-b-4 border-myblue pb-3">
...
I conducted a focus group with customers of that demographic, allowing them to share their preferences as they viewed different mockups of the website and provided feedback on what they liked and disliked. Through this process, I discovered that the user base favored larger images and a clean, uncluttered presentation of content. Taking their preferences into consideration, we prioritized showcasing images prominently and using minimalistic frames to facilitate easy consumption of content.
  ...
  <img
    class="rounded-xl shadow-lg w-full"
    loading="lazy"
    src="/project/grace/gf-component.webp"
    alt=""
  />
