...
<div class="container mx-auto my-12">
    ...
    <div class="grid lg:grid-cols-2 col-cols-1 mx-5">
      ...
      <a
        class="lg:hidden md:block place-self-center mb-5 hover:scale-105 transition"
        href={link_href}
      >
        <div class="img-click-container transition hover:scale-100">
          <img
      ...
      <a
        class="hidden lg:block place-self-center mb-5 hover:scale-105 transition"
        href={link_href}
      >
        <div class="img-click-container transition hover:scale-100">
          <img
